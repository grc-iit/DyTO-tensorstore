...
#ifndef TENSORSTORE_DRIVER_HDF5_DRIVER_IMPL_H_
#define TENSORSTORE_DRIVER_HDF5_DRIVER_IMPL_H_
...
//#include "tensorstore/driver/hdf5/spec.h"
...
class HDF5DriverSpec
 ...
 public:
  ...
  HDF5PartialMetadata partial_metadata;
...
//   Result<SpecRankAndFieldInfo> GetSpecInfo() const;
  ...
  TENSORSTORE_DECLARE_JSON_DEFAULT_BINDER(HDF5DriverSpec,
...
using HDF5DriverBase = internal_kvs_backed_chunk_driver::RegisteredKvsDriver<
    ...
    internal::ChunkCacheReadWriteDriverMixin<
        HDF5Driver, internal_kvs_backed_chunk_driver::KvsChunkedDriverBase>>;
...
class HDF5Driver : public HDF5DriverBase {
 ...
 public:
  ...
  const HDF5Metadata& metadata() const {
    return *static_cast<const HDF5Metadata*>(
...
#endif  // TENSORSTORE_DRIVER_HDF5_DRIVER_IMPL_H_
